...
(trans.start = []),
  ...
  (trans.show_detailed_b["en-US"] = "to toggle detailed information about how <a href='https://github.com/librespeed/speedtest' target='_blank'>LibreSpeed</a> works and the algorithms involved."),
  (trans.desc_ping = []),
...
var chart1,
  ...
  data = [],
  timers = [],
  parameters = { overheadCompensationFactor: 1, time_ul_max: 15, time_dl_max: 15, time_ulGraceTime: 3, time_dlGraceTime: 1.5, time_auto: !1, count_ping: 500 },
  max_upload = 0,
  min_upload = 0,
  max_download = 0,
  min_download = 0,
